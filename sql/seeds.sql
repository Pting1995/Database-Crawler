...
VALUES ("Magikul Toom!", 3, 0, 0, "I can't read this... But it makes me FEEL smarter!");
INSERT INTO items (name, intelligence, strength, dexterity, description)
...
VALUES ("The Wise Rock", "I hear a cave-in up ahead but luckily it's nowhere near me. I continue onwards and soon I meet a rock golem. I watch him as he practices magic. He weaves magic spells together like an experienced mage but suddenly stops when he hears me and chucks a barrel sized rock in my direction like it's nothing. It clearly wasn’t meant to hit me but to scare me. What do I do?", "images/rock-golem.jpg", 1);
...
-- goblin
INSERT INTO options (text, resolution, str_req, dex_req, int_req, str_gain, dex_gain, int_gain, LocationId) 
VALUES ("You attempt to ask the goblin for help because you are lost and have no clue on how to get out of the dungeon", "he gives you his knowledge of the area",  0, 0, 0, 0, 0, 5, 5);
INSERT INTO options (text, resolution,str_req, dex_req, int_req, str_gain, dex_gain, int_gain, LocationId) 
